...
```
$ ./xmlrpc-server.py
127.0.0.1 - - [19/Nov/2019 14:22:43] "POST /RPC2 HTTP/1.1" 200 -
```
...
```
    1   0.000000    127.0.0.1 → 127.0.0.1    TCP 64 49378 → 8888 [SYN] Seq=0 Win=65535 Len=0 MSS=16344 WS=64 TSval=485435680 TSecr=0 SACK_PERM=1
    3   0.000084    127.0.0.1 → 127.0.0.1    TCP 64 8888 → 49378 [SYN, ACK] Seq=0 Ack=1 Win=65535 Len=0 MSS=16344 WS=64 TSval=485435680 TSecr=485435680 SACK_PERM=1
    5   0.000092    127.0.0.1 → 127.0.0.1    TCP 52 49378 → 8888 [ACK] Seq=1 Ack=1 Win=408256 Len=0 TSval=485435680 TSecr=485435680
    7   0.000100    127.0.0.1 → 127.0.0.1    TCP 52 [TCP Window Update] 8888 → 49378 [ACK] Seq=1 Ack=1 Win=408256 Len=0 TSval=485435680 TSecr=485435680
   10   0.001955    127.0.0.1 → 127.0.0.1    HTTP/XML 259 POST /RPC2 HTTP/1.1
...
xmlrpc-common forms the base of xmlrpc, and only a few artifacts reference it. But taking a look at the users of xmlrpc client, we find 124 artifacts embed xmlrpc-common transitively.
